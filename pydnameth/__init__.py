...
from pydnameth.scripts.develop.residuals_special.table import residuals_special_table_linreg_dev, \
    residuals_special_table_aggregator_dev
from pydnameth.scripts.develop.residuals_common.table import residuals_common_table_linreg_dev, \
    residuals_common_table_aggregator_dev
from pydnameth.scripts.develop.betas.table import betas_table_linreg_dev, betas_table_variance_linreg_dev, \
    betas_table_polygon_dev, betas_table_z_test_linreg_dev, betas_table_aggregator_dev, \

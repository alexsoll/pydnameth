        ...
        if config.experiment.task == Task.table:
            ...
            if config.experiment.method == Method.linreg:
                ...
                metrics = [
                    ...
                    'std_b_best_R2',
                    'std_b_lin_lin_R2',
                    'std_b_lin_lin_intercept',
                    'std_b_lin_lin_slope',
                    'std_b_lin_lin_intercept_std',
                    'std_b_lin_lin_slope_std',
                    'std_b_lin_lin_intercept_p_value',
                    'std_b_lin_lin_slope_p_value',
                    'std_b_lin_log_R2',
                    'std_b_lin_log_intercept',
                    'std_b_lin_log_slope',
                    'std_b_lin_log_intercept_std',
                    'std_b_lin_log_slope_std',
                    'std_b_lin_log_intercept_p_value',
                    'std_b_lin_log_slope_p_value',
                    'std_b_log_log_R2',
                    'std_b_log_log_intercept',
                    'std_b_log_log_slope',
                    'std_b_log_log_intercept_std',
                    'std_b_log_log_slope_std',
                    'std_b_log_log_intercept_p_value',
                    'std_b_log_log_slope_p_value',

                    'std_m_best_type',
                    'std_m_best_R2',
                    'std_m_lin_lin_R2',
                    'std_m_lin_lin_intercept',
                    'std_m_lin_lin_slope',
                    'std_m_lin_lin_intercept_std',
                    'std_m_lin_lin_slope_std',
                    'std_m_lin_lin_intercept_p_value',
                    'std_m_lin_lin_slope_p_value',
                    'std_m_lin_log_R2',
                    'std_m_lin_log_intercept',
                    'std_m_lin_log_slope',
                    'std_m_lin_log_intercept_std',
                    'std_m_lin_log_slope_std',
                    'std_m_lin_log_intercept_p_value',
                    'std_m_lin_log_slope_p_value',
                    'std_m_log_log_R2',
                    'std_m_log_log_intercept',
                    'std_m_log_log_slope',
                    'std_m_log_log_intercept_std',
                    'std_m_log_log_slope_std',
                    'std_m_log_log_intercept_p_value',
                    'std_m_log_log_slope_p_value',

                    'std_t_best_type',
                    'std_t_best_R2',
                    'std_t_lin_lin_R2',
                    'std_t_lin_lin_intercept',
                    'std_t_lin_lin_slope',
                    'std_t_lin_lin_intercept_std',
                    'std_t_lin_lin_slope_std',
                    'std_t_lin_lin_intercept_p_value',
                    'std_t_lin_lin_slope_p_value',
                    'std_t_lin_log_R2',
                    'std_t_lin_log_intercept',
                    'std_t_lin_log_slope',
                    'std_t_lin_log_intercept_std',
                    'std_t_lin_log_slope_std',
                    'std_t_lin_log_intercept_p_value',
                    'std_t_lin_log_slope_p_value',
                    'std_t_log_log_R2',
                    'std_t_log_log_intercept',
                    'std_t_log_log_slope',
                    'std_t_log_log_intercept_std',
                    'std_t_log_log_slope_std',
                    'std_t_log_log_intercept_p_value',
                    'std_t_log_log_slope_p_value',
